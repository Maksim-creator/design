...
/* harmony import */ var _modules_showImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/showImage */ "./src/js/modules/showImage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showImage__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])('#up');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (!sizeBlock.value || !materialBlock.value) {
      ...
      resultBlock.textContent = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u0432\u0430\u0448\u0435\u0433\u043E \u0437\u0430\u043A\u0430\u0437\u0430: ".concat(Math.round(sum * 0.7), "\u0433\u0440\u043D.");
    } else {
      resultBlock.textContent = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u0432\u0430\u0448\u0435\u0433\u043E \u0437\u0430\u043A\u0430\u0437\u0430: ".concat(sum, "\u0433\u0440\u043D.");
    }
  };
...
var drop = function drop() {
  ...
  enter.forEach(function (eventName) {
    fileInputs.forEach(function (input) {
      input.addEventListener(eventName, function () {
  ...
  fileInputs.forEach(function (input, i) {
    input.addEventListener('drop', function (e) {
      if (i == 0) {
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["postData"])(path.designer, formData);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    this.value = matrix.replace(/./g, function (item) {
      return /[_\d]/.test(item) && i < val.length ? val.charAt(i++) : i >= val.length ? '' : item;
    });
...
var scrolling = function scrolling(upSelector) {
  var upLink = document.querySelector(upSelector);
  window.addEventListener('scroll', function () {
...
var showImage = function showImage(blocksSelector) {
  var blocks = document.querySelectorAll(blocksSelector);
  blocks.forEach(function (block) {
    var img = block.querySelector('img');
    block.addEventListener('mouseover', function () {
      img.src = img.src.slice(0, -4) + '-1.png';
      block.querySelectorAll(".".concat(block.className, " p:not(.sizes-hit)")).forEach(function (p) {
...
var showMoreStyles = function showMoreStyles(trigger) {
  var btn = document.querySelector(trigger);
  btn.addEventListener('click', function () {
    var _this = this;

    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getData"])('http://localhost:3000/styles').then(function (styles) {
